...
export const WelcomePromoModal: React.FC<WelcomePromoModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
      <div className="w-full max-w-md bg-white rounded-3xl overflow-hidden shadow-2xl border border-red-100 animate-scale-up my-auto max-h-[90vh] flex flex-col">
        ...
        <div className="relative bg-gradient-to-br from-gray-950 via-gray-900 to-red-950 text-white p-5 pb-6">
          ...
          <h2 className="text-lg font-black text-white leading-tight">
            {isAr
              ? 'مرحباً بك! انضم الآن إلى باقات أسطول VIP وضاعف أرباحك'
              : 'Welcome! Maximize Daily Profits with Exclusive VIP Tiers'}
          </h2>
          <p className="text-xs text-gray-300 mt-1.5 leading-relaxed">
            {isAr
              ? 'المنصة العالمية الأولى للاستثمار في أسطول السيارات الرياضية الفارهة، مهام تأجير يومية، أرباح تسوية فورية، وسحب مؤكد خلال 24 ساعة!'
        ...
        <div className="p-4 overflow-y-auto space-y-3.5 text-xs text-gray-700 flex-1">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-3 flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-600 mt-0.5 leading-relaxed">
                {isAr
                  ? 'باقة VIP0 تجريبية فقط. الترقية إلى VIP1 فما فوق تفتح لك السحب المباشر وأرباحاً مضاعفة تبدأ من 7.50$ وتصل حتى 900$ يومياً!'
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="font-bold text-gray-900 text-xs flex items-center gap-1">
                ...
                <span>{isAr ? 'أبرز باقات VIP الأكثر طلباً:' : 'Most Lucrative VIP Packages:'}</span>
              </span>
              ...
              {promoTiers.map((tier) => (
                ...
                >
                  ...
                  <div className="mt-2 pt-1.5 border-t border-gray-200/80 flex items-center justify-between text-[11px]">
                    <span className="text-gray-500 text-[10px]">{isAr ? 'الربح اليومي:' : 'Daily:'}</span>
          ...
          <div className="bg-gray-50 rounded-2xl p-3 border border-gray-100 space-y-2">
            <div className="flex items-center gap-2 text-[11px] text-gray-700">
              ...
              <span>{isAr ? 'سحب فوري مضمون خلال 24 ساعة بأعلى معايير الأمان' : 'Guaranteed 24h withdrawal processing with full security'}</span>
            </div>
            <div className="flex items-center gap-2 text-[11px] text-gray-700">
              <Zap className="w-4 h-4 text-amber-500 shrink-0" />
              <span>{isAr ? 'فرصة مجانية تتجدد كل 24 ساعة في عجلة الحظ لربح رصيد USDT مجاني' : 'Free lucky draw refill every 24 hours to win free USDT prizes'}</span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h5 className="font-extrabold text-xs">
                  {isAr ? 'هدية الترحيب بانتظارك!' : 'Welcome Gift Ready!'}
                </h5>
                <p className="text-[10px] text-red-100">
                  {isAr ? 'قم بتدوير عجلة الحظ الآن مجاناً' : 'Spin the lucky wheel now for free cash'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-100 space-y-2">
          ...
          >
            ...
            <span>{isAr ? 'المتابعة لتدوير عجلة الحظ واستلام الهدية' : 'Continue to Lucky Wheel & Claim Spin'}</span>
