      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="font-bold text-gray-900 text-sm">
            {language === 'ar' ? 'باقات الاستثمار VIP (من VIP0 إلى VIP9)' : 'VIP Investment Tiers (VIP0 - VIP9)'}
          </h3>
          <p className="text-[11px] text-gray-500">
            {language === 'ar' ? 'قم بالترقية لزيادة الأرباح اليومية وفتح السحب' : 'Upgrade to boost daily returns & enable withdrawals'}
          </p>
        </div>
